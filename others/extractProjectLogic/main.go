...
import (
	...
	"extractProjectLogic/handlers"
	"extractProjectLogic/repositories"
	_ "github.com/lib/pq"
)
...
func getDB() *sql.DB {
	url := "host=localhost port=5432 user=postgres dbname=app_test password=123456 sslmode=disable"
