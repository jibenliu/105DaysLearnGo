...
const (
	...
	PaymentMethod_APPLE_PAY   PaymentMethod_Type = 4
)
...
type Order struct {
	...
	Status    Order_Status           `protobuf:"varint,6,opt,name=status,proto3,enum=Order_Status" json:"status,omitempty"`
}
...
type PaymentMethod struct {
	...
	PaymentType           PaymentMethod_Type `protobuf:"varint,1,opt,name=payment_type,json=paymentType,proto3,enum=PaymentMethod_Type" json:"payment_type,omitempty"`
...
type ListOrderRequest struct {
	...
	Statuses Order_Status `protobuf:"varint,2,opt,name=statuses,proto3,enum=Order_Status" json:"statuses,omitempty"`
}
...
var file_order_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03,
	...
	0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x39, 0x0a, 0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f,
	...
	0x65, 0x12, 0x25, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x0d, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	,
	...
	0x72, 0x69, 0x63, 0x65, 0x22, 0x68, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x05, 0x69, 0x74,
	0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x49, 0x74, 0x65, 0x6d,
	0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x35, 0x0a, 0x0e, 0x70, 0x61, 0x79, 0x6d, 0x65,
	...
	0x0d, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x22, 0x33,
	...
	0x64, 0x65, 0x72, 0x22, 0x31, 0x0a, 0x14, 0x52, 0x65, 0x74, 0x72, 0x69, 0x65, 0x76, 0x65, 0x4f,
	...
	0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x35, 0x0a, 0x15, 0x52, 0x65, 0x74, 0x72, 0x69, 0x65,
	...
	,
	...
	0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x05, 0x69, 0x74, 0x65,
	0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x52,
	0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x33, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	0x72, 0x64, 0x65, 0x72, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x4f, 0x0a, 0x10, 0x4c,
	...
	0x73, 0x12, 0x29, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x08, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x22, 0x31, 0x0a, 0x11,
	...
	0x12, 0x33, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x13, 0x2e, 0x43, 0x72, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65, 0x74, 0x72, 0x69, 0x65, 0x76,
	0x65, 0x12, 0x15, 0x2e, 0x52, 0x65, 0x74, 0x72, 0x69, 0x65, 0x76, 0x65, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x52, 0x65, 0x74, 0x72, 0x69,
	0x65, 0x76, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x33, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x13, 0x2e, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a, 0x04, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x11, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x6f,
...
var file_order_proto_goTypes = []interface{}{
	...
	(PaymentMethod_Type)(0),       // 1: PaymentMethod.Type
	(*Order)(nil),                 // 2: Order
	...
	(*RetrieveOrderRequest)(nil),  // 7: RetrieveOrderRequest
	(*RetrieveOrderResponse)(nil), // 8: RetrieveOrderResponse
	(*UpdateOrderRequest)(nil),    // 9: UpdateOrderRequest
	(*UpdateOrderResponse)(nil),   // 10: UpdateOrderResponse
	(*DeleteOrderRequest)(nil),    // 11: DeleteOrderRequest
	(*DeleteOrderResponse)(nil),   // 12: DeleteOrderResponse
	(*ListOrderRequest)(nil),      // 13: ListOrderRequest
	(*ListOrderResponse)(nil),     // 14: ListOrderResponse
	(*timestamppb.Timestamp)(nil), // 15: google.protobuf.Timestamp
}
var file_order_proto_depIdxs = []int32{
	4,  // 0: Order.items:type_name -> Item
	15, // 1: Order.order_date:type_name -> google.protobuf.Timestamp
	0,  // 2: Order.status:type_name -> Order.Status
	1,  // 3: PaymentMethod.payment_type:type_name -> PaymentMethod.Type
	4,  // 4: CreateOrderRequest.items:type_name -> Item
	3,  // 5: CreateOrderRequest.payment_method:type_name -> PaymentMethod
	2,  // 6: CreateOrderResponse.order:type_name -> Order
	2,  // 7: RetrieveOrderResponse.order:type_name -> Order
	4,  // 8: UpdateOrderRequest.items:type_name -> Item
	3,  // 9: UpdateOrderRequest.payment_method:type_name -> PaymentMethod
	2,  // 10: UpdateOrderResponse.order:type_name -> Order
	4,  // 11: DeleteOrderRequest.items:type_name -> Item
	2,  // 12: DeleteOrderResponse.order:type_name -> Order
	0,  // 13: ListOrderRequest.statuses:type_name -> Order.Status
	2,  // 14: ListOrderResponse.order:type_name -> Order
	5,  // 15: OrderService.Create:input_type -> CreateOrderRequest
	7,  // 16: OrderService.Retrieve:input_type -> RetrieveOrderRequest
	9,  // 17: OrderService.Update:input_type -> UpdateOrderRequest
	11, // 18: OrderService.Delete:input_type -> DeleteOrderRequest
	13, // 19: OrderService.List:input_type -> ListOrderRequest
	6,  // 20: OrderService.Create:output_type -> CreateOrderResponse
	8,  // 21: OrderService.Retrieve:output_type -> RetrieveOrderResponse
	10, // 22: OrderService.Update:output_type -> UpdateOrderResponse
	12, // 23: OrderService.Delete:output_type -> DeleteOrderResponse
	14, // 24: OrderService.List:output_type -> ListOrderResponse
